...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-purple-cyan': 'linear-gradient(135deg, hsla(var(--accent), 0.12) 0%, hsla(var(--primary), 0.06) 100%)',
        'gradient-card-border': 'linear-gradient(180deg, hsla(var(--border), 0.8) 0%, hsla(var(--border), 0.3) 50%, hsla(var(--border), 0.1) 100%)',
        'gradient-cyan': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.8) 100%)',
        'primary-gradient': 'linear-gradient(135deg, hsl(142, 71%, 45%) 0%, hsl(142, 71%, 36%) 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 0 20px hsl(142 71% 45% / 0.3)',
        'glow-purple': '0 0 20px hsl(0 0% 58% / 0.18)',
        'glow-success': '0 0 20px hsl(142 71% 45% / 0.28)',
        'glow-danger': '0 0 20px hsl(0 84% 58% / 0.28)',
        'cyan/20': '0 12px 28px hsl(142 71% 45% / 0.2)',
